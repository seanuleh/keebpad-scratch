...
extern "C" void app_main()
{
    ...
    // To use arduino this needs to be a .cpp file and we need to use alot of extern "C" commands
    Serial.begin(115200);
    Serial.println("app_maizn()");
